...
class UsahaJasaGasAdminController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('admin.usahajasagas.create', ['kgusahajasagas' => $kgusahajasagas, 'desa_id' => $desa_id]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $usahajasagas->desa_id = $request->desa_id;
    ...
    public function edit($id)
    {
        ...
        return view('admin.usahajasagas.edit', ['kgusahajasagas' => $kgusahajasagas, 'usahajasagas' => $usahajasagas]);
    }
    ...
    {
        $usahajasagas = UsahaJasaGas::ambil($id);
        $usahajasagas->desa_id = $request->input('desa_id');
