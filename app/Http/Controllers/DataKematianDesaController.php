...
class DataKematianDesaController extends Controller
{
    /**
    ...
    {
        $datakematian = DataKematian::where('desa_id', auth()->user()->desa_id)->get();
        return view('operatordesa.kelola-data.kematian.index', compact('datakematian'));
    }
    ...
    {
        return view('operatordesa.kelola-data.kematian.create');
    }
    ...
    public function cari(Request $request)
    {
        ...
        return view('operatordesa.kelola-data.kematian.ambil', ['datapenduduk' => $datapenduduk, 'desa_id' => $desa_id]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $datakematian->save();
        return redirect()->route('keloladata-datakematiandesa.index');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('operatordesa.kelola-data.kematian.show', compact('desa_id', 'datakematian'));
    }
    ...
    public function edit(Request $request, $id)
    {
        $desa_id = Desa::ambilSemua();
        $datakematian = DataKematian::ambil($id);
        return view('operatordesa.kelola-data.kematian.edit', compact('desa_id', 'datakematian'));
    }
