...
class ProfilDesaKecamatanController extends Controller
{
    /**
    ...
    {
        $desa = Desa::get();
        return view('admin.profil-desa.index', compact('desa'));
    }
    ...
    public function edit($desa_id)
    {
        ...
        $datatanah = DataTanah::where('desa_id', $desa_id)->first();
        $iklimjeniskesuburantanah = IklimJenisKesuburanTanah::where('desa_id', $desa_id)->first();
        $topografiletakorbitasi = TopografiLetakOrbitasi::where('desa_id', $desa_id)->first();
        $pertanian = Pertanian::where('desa_id', $desa_id)->first();
        $pemasaranpanganbuah = PemasaranPanganBuah::where('desa_id', $desa_id)->first();
        $pemasaranhasilperkebunan = PemasaranHasilPerkebunan::where('desa_id', $desa_id)->first();
        $pemasaranhasilhutan = PemasaranHasilHutan::where('desa_id', $desa_id)->first();
        $pemasaranhasilgalian = PemasaranHasilGalian::where('desa_id', $desa_id)->first();
        $pemasaranhasilikan = PemasaranHasilIkan::where('desa_id', $desa_id)->first();
        $manfaatkondisidanau = ManfaatKondisiDanau::where('desa_id', $desa_id)->first();
        $ketersediaanlahanternak = KetersediaanLahanTernak::where('desa_id', $desa_id)->first();
        $pemasaranhasilternak = PemasaranHasilTernak::where('desa_id', $desa_id)->first();
        $hijauanpakanternak = HijauanPakanTernak::where('desa_id', $desa_id)->first();
        $rawa = Rawa::where('desa_id', $desa_id)->first();
        $sungai = Sungai::where('desa_id', $desa_id)->first();
        $prasaranasaranakebersihan = PrasaranaSaranaKebersihan::where('desa_id', $desa_id)->get();
        $prasaranahiburanwisata = PrasaranaHiburanWisata::where('desa_id', $desa_id)->get();
        $prasaranaenergipenerangan = PrasaranaEnergiPenerangan::where('desa_id', $desa_id)->get();
        $prasaranasaranapendidikan = PrasaranaSaranaPendidikan::where('desa_id', $desa_id)->get();
        $prasaranaperibadatan = PrasaranaPeribadatan::where('desa_id', $desa_id)->get();
        $prasaranaolahraga = PrasaranaOlahraga::where('desa_id', $desa_id)->get();
        $prasaranakesehatan = PrasaranaKesehatan::where('desa_id', $desa_id)->get();
        $saranakesehatan = SaranaKesehatan::where('desa_id', $desa_id)->get();
        $telepon = Telepon::where('desa_id', $desa_id)->get();
        $radiotv = RadioTv::where('desa_id', $desa_id)->get();
        $koran = Koran::where('desa_id', $desa_id)->get();
        $potensiwisata = PotensiWisata::where('desa_id', $desa_id)->get();
        $ruangpublik = RuangPublik::where('desa_id', $desa_id)->get();
        $tanamanpangan = TanamanPangan::where('desa_id', $desa_id)->get();
        $komoditasbuah = KomoditasBuah::where('desa_id', $desa_id)->get();
        $tanamanapotik = TanamanApotik::where('desa_id', $desa_id)->get();
        $hasilhutan = HasilHutan::where('desa_id', $desa_id)->get();
        $kondisihutan = KondisiHutan::where('desa_id', $desa_id)->get();
        $dampakolahhutan = DampakOlahHutan::where('desa_id', $desa_id)->get();

        $jenispopulasiternak = JenisPopulasiTernak::where('desa_id', $desa_id)->get();
        $produksiternak = ProduksiTernak::where('desa_id', $desa_id)->get();
        $pemilikusahaternak = PemilikUsahaTernak::where('desa_id', $desa_id)->get();
        $alatproduksilaut = AlatProduksiLaut::where('desa_id', $desa_id)->get();
        $alatproduksitawar = AlatProduksiTawar::where('desa_id', $desa_id)->get();
        $jenisikan = JenisIkan::where('desa_id', $desa_id)->get();
        $bahangalian = BahanGalian::where('desa_id', $desa_id)->get();

        $potensiairsda = PotensiAirSda::where('desa_id', $desa_id)->get();
        $sumberairbersih = SumberAirBersih::where('desa_id', $desa_id)->get();
        $hasilperkebunan = HasilPerkebunan::where('desa_id', $desa_id)->get();
        $kebisingan = Kebisingan::where('desa_id', $desa_id)->get();
        $kualitasudara = KualitasUdara::where('desa_id', $desa_id)->get();
        $kehutanan = Kehutanan::where('desa_id', $desa_id)->get();
        $airpanas = AirPanas::where('desa_id', $desa_id)->get();
        $kantorpos = KantorPos::where('desa_id', $desa_id)->get();
        $prasaranadarat = PrasaranaDarat::where('desa_id', $desa_id)->get();
        $saranadarat = SaranaDarat::where('desa_id', $desa_id)->get();
        $prasaranalaut = PrasaranaLaut::where('desa_id', $desa_id)->get();
        $saranalaut = SaranaLaut::where('desa_id', $desa_id)->get();
        $prasaranaudara = PrasaranaUdara::where('desa_id', $desa_id)->get();
        $prasaranalkdk = PrasaranaLKDK::where('desa_id', $desa_id)->first();
        $prasaranapemerintahan = PrasaranaPemerintahan::where('desa_id', $desa_id)->first();
        $prasaranabpddusun = PrasaranaBPDDusun::where('desa_id', $desa_id)->first();
        $prasaranairigasi = PrasaranaIrigasi::where('desa_id', $desa_id)->first();
        $prasaranaairbersih = PrasaranaAirBersih::where('desa_id', $desa_id)->first();
        $lembagakeamanan = LembagaKeamanan::where('desa_id', $desa_id)->first();
        $lembagaadat = LembagaAdat::where('desa_id', $desa_id)->first();
        ...
        $umur75atas_lk = DataPenduduk::where('tanggallahir', '<=', $tujuhpuluhlimaatas_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 75 Th
        $tujuhpuluhlima_tahun = \Carbon\Carbon::today()->subYears(75)->format('Y-m-d');
        $umur75_lk = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhlimaatas_tahun)->where('tanggallahir', '<=', $tujuhpuluhlima_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 74 Th
        $tujuhpuluhempat_tahun = \Carbon\Carbon::today()->subYears(74)->format('Y-m-d');
        $umur74_lk = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhlima_tahun)->where('tanggallahir', '<=', $tujuhpuluhempat_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 73 Th
        $tujuhpuluhtiga_tahun = \Carbon\Carbon::today()->subYears(73)->format('Y-m-d');
        $umur73_lk = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhempat_tahun)->where('tanggallahir', '<=', $tujuhpuluhtiga_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 72 Th
        $tujuhpuluhdua_tahun = \Carbon\Carbon::today()->subYears(72)->format('Y-m-d');
        $umur72_lk = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhtiga_tahun)->where('tanggallahir', '<=', $tujuhpuluhdua_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 71 Th
        $tujuhpuluhsatu_tahun = \Carbon\Carbon::today()->subYears(71)->format('Y-m-d');
        $umur71_lk = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhdua_tahun)->where('tanggallahir', '<=', $tujuhpuluhsatu_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 70 Th
        $tujuhpuluh_tahun = \Carbon\Carbon::today()->subYears(70)->format('Y-m-d');
        $umur70_lk = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhsatu_tahun)->where('tanggallahir', '<=', $tujuhpuluh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 69 Th
        $enampuluhsembilan_tahun = \Carbon\Carbon::today()->subYears(69)->format('Y-m-d');
        $umur69_lk = DataPenduduk::where('tanggallahir', '>', $tujuhpuluh_tahun)->where('tanggallahir', '<=', $enampuluhsembilan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 68 Th
        $enampuluhdelapan_tahun = \Carbon\Carbon::today()->subYears(68)->format('Y-m-d');
        $umur68_lk = DataPenduduk::where('tanggallahir', '>', $enampuluhsembilan_tahun)->where('tanggallahir', '<=', $enampuluhdelapan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 67 Th
        $enampuluhtujuh_tahun = \Carbon\Carbon::today()->subYears(67)->format('Y-m-d');
        $umur67_lk = DataPenduduk::where('tanggallahir', '>', $enampuluhdelapan_tahun)->where('tanggallahir', '<=', $enampuluhtujuh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 66 Th
        $enampuluhenam_tahun = \Carbon\Carbon::today()->subYears(66)->format('Y-m-d');
        $umur66_lk = DataPenduduk::where('tanggallahir', '>', $enampuluhtujuh_tahun)->where('tanggallahir', '<=', $enampuluhenam_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 65 Th
        $enampuluhlima_tahun = \Carbon\Carbon::today()->subYears(65)->format('Y-m-d');
        $umur65_lk = DataPenduduk::where('tanggallahir', '>', $enampuluhenam_tahun)->where('tanggallahir', '<=', $enampuluhlima_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 64 Th
        $enampuluhempat_tahun = \Carbon\Carbon::today()->subYears(64)->format('Y-m-d');
        $umur64_lk = DataPenduduk::where('tanggallahir', '>', $enampuluhlima_tahun)->where('tanggallahir', '<=', $enampuluhempat_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 63 Th
        $enampuluhtiga_tahun = \Carbon\Carbon::today()->subYears(63)->format('Y-m-d');
        $umur63_lk = DataPenduduk::where('tanggallahir', '>', $enampuluhempat_tahun)->where('tanggallahir', '<=', $enampuluhtiga_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 62 Th
        $enampuluhdua_tahun = \Carbon\Carbon::today()->subYears(62)->format('Y-m-d');
        $umur62_lk = DataPenduduk::where('tanggallahir', '>', $enampuluhtiga_tahun)->where('tanggallahir', '<=', $enampuluhdua_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 61 Th
        $enampuluhsatu_tahun = \Carbon\Carbon::today()->subYears(61)->format('Y-m-d');
        $umur61_lk = DataPenduduk::where('tanggallahir', '>', $enampuluhdua_tahun)->where('tanggallahir', '<=', $enampuluhsatu_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 60 Th
        $enampuluh_tahun = \Carbon\Carbon::today()->subYears(60)->format('Y-m-d');
        $umur60_lk = DataPenduduk::where('tanggallahir', '>', $enampuluhsatu_tahun)->where('tanggallahir', '<=', $enampuluh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 59 Th
        $limapuluhsembilan_tahun = \Carbon\Carbon::today()->subYears(59)->format('Y-m-d');
        $umur59_lk = DataPenduduk::where('tanggallahir', '>', $enampuluh_tahun)->where('tanggallahir', '<=', $limapuluhsembilan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 58 Th
        $limapuluhdelapan_tahun = \Carbon\Carbon::today()->subYears(58)->format('Y-m-d');
        $umur58_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhsembilan_tahun)->where('tanggallahir', '<=', $limapuluhdelapan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 57 Th
        $limapuluhtujuh_tahun = \Carbon\Carbon::today()->subYears(57)->format('Y-m-d');
        $umur57_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhdelapan_tahun)->where('tanggallahir', '<=', $limapuluhtujuh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 56 Th
        $limapuluhenam_tahun = \Carbon\Carbon::today()->subYears(56)->format('Y-m-d');
        $umur56_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhtujuh_tahun)->where('tanggallahir', '<=', $limapuluhenam_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 55 Th
        $limapuluhlima_tahun = \Carbon\Carbon::today()->subYears(55)->format('Y-m-d');
        $umur55_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhenam_tahun)->where('tanggallahir', '<=', $limapuluhlima_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 54 Th
        $limapuluhempat_tahun = \Carbon\Carbon::today()->subYears(54)->format('Y-m-d');
        $umur54_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhlima_tahun)->where('tanggallahir', '<=', $limapuluhempat_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 53 Th
        $limapuluhtiga_tahun = \Carbon\Carbon::today()->subYears(53)->format('Y-m-d');
        $umur53_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhempat_tahun)->where('tanggallahir', '<=', $limapuluhtiga_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 52 Th
        $limapuluhdua_tahun = \Carbon\Carbon::today()->subYears(52)->format('Y-m-d');
        $umur52_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhtiga_tahun)->where('tanggallahir', '<=', $limapuluhdua_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 51 Th
        $limapuluhsatu_tahun = \Carbon\Carbon::today()->subYears(51)->format('Y-m-d');
        $umur51_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhdua_tahun)->where('tanggallahir', '<=', $limapuluhsatu_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 50 Th
        $limapuluh_tahun = \Carbon\Carbon::today()->subYears(50)->format('Y-m-d');
        $umur50_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhsatu_tahun)->where('tanggallahir', '<=', $limapuluh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 49 Th
        $empatpuluhsembilan_tahun = \Carbon\Carbon::today()->subYears(49)->format('Y-m-d');
        $umur49_lk = DataPenduduk::where('tanggallahir', '>', $limapuluh_tahun)->where('tanggallahir', '<=', $empatpuluhsembilan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 48 Th
        $empatpuluhdelapan_tahun = \Carbon\Carbon::today()->subYears(48)->format('Y-m-d');
        $umur48_lk = DataPenduduk::where('tanggallahir', '>', $empatpuluhsembilan_tahun)->where('tanggallahir', '<=', $empatpuluhdelapan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 47 Th
        $empatpuluhtujuh_tahun = \Carbon\Carbon::today()->subYears(47)->format('Y-m-d');
        $umur47_lk = DataPenduduk::where('tanggallahir', '>', $empatpuluhdelapan_tahun)->where('tanggallahir', '<=', $empatpuluhtujuh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 46 Th
        $empatpuluhenam_tahun = \Carbon\Carbon::today()->subYears(46)->format('Y-m-d');
        $umur46_lk = DataPenduduk::where('tanggallahir', '>', $empatpuluhtujuh_tahun)->where('tanggallahir', '<=', $empatpuluhenam_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 45 Th
        $empatpuluhlima_tahun = \Carbon\Carbon::today()->subYears(45)->format('Y-m-d');
        $umur45_lk = DataPenduduk::where('tanggallahir', '>', $empatpuluhenam_tahun)->where('tanggallahir', '<=', $empatpuluhlima_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 44 Th
        $empatpuluhempat_tahun = \Carbon\Carbon::today()->subYears(44)->format('Y-m-d');
        $umur44_lk = DataPenduduk::where('tanggallahir', '>', $empatpuluhlima_tahun)->where('tanggallahir', '<=', $empatpuluhempat_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 43 Th
        $empatpuluhtiga_tahun = \Carbon\Carbon::today()->subYears(43)->format('Y-m-d');
        $umur43_lk = DataPenduduk::where('tanggallahir', '>', $empatpuluhempat_tahun)->where('tanggallahir', '<=', $empatpuluhtiga_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 42 Th
        $empatpuluhdua_tahun = \Carbon\Carbon::today()->subYears(42)->format('Y-m-d');
        $umur42_lk = DataPenduduk::where('tanggallahir', '>', $empatpuluhtiga_tahun)->where('tanggallahir', '<=', $empatpuluhdua_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 41 Th
        $empatpuluhsatu_tahun = \Carbon\Carbon::today()->subYears(41)->format('Y-m-d');
        $umur41_lk = DataPenduduk::where('tanggallahir', '>', $empatpuluhdua_tahun)->where('tanggallahir', '<=', $empatpuluhsatu_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 40 Th
        $empatpuluh_tahun = \Carbon\Carbon::today()->subYears(40)->format('Y-m-d');
        $umur40_lk = DataPenduduk::where('tanggallahir', '>', $empatpuluhsatu_tahun)->where('tanggallahir', '<=', $empatpuluh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 39 Th
        $tigapuluhsembilan_tahun = \Carbon\Carbon::today()->subYears(39)->format('Y-m-d');
        $umur39_lk = DataPenduduk::where('tanggallahir', '>', $empatpuluh_tahun)->where('tanggallahir', '<=', $tigapuluhsembilan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 38 Th
        $tigapuluhdelapan_tahun = \Carbon\Carbon::today()->subYears(38)->format('Y-m-d');
        $umur38_lk = DataPenduduk::where('tanggallahir', '>', $tigapuluhsembilan_tahun)->where('tanggallahir', '<=', $tigapuluhdelapan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 37 Th
        $tigapuluhtujuh_tahun = \Carbon\Carbon::today()->subYears(37)->format('Y-m-d');
        $umur37_lk = DataPenduduk::where('tanggallahir', '>', $tigapuluhdelapan_tahun)->where('tanggallahir', '<=', $tigapuluhtujuh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 36 Th
        $tigapuluhenam_tahun = \Carbon\Carbon::today()->subYears(36)->format('Y-m-d');
        $umur36_lk = DataPenduduk::where('tanggallahir', '>', $tigapuluhtujuh_tahun)->where('tanggallahir', '<=', $tigapuluhenam_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 35 Th
        $tigapuluhlima_tahun = \Carbon\Carbon::today()->subYears(35)->format('Y-m-d');
        $umur35_lk = DataPenduduk::where('tanggallahir', '>', $tigapuluhenam_tahun)->where('tanggallahir', '<=', $tigapuluhlima_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 34 Th
        $tigapuluhempat_tahun = \Carbon\Carbon::today()->subYears(34)->format('Y-m-d');
        $umur34_lk = DataPenduduk::where('tanggallahir', '>', $tigapuluhlima_tahun)->where('tanggallahir', '<=', $tigapuluhempat_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 33 Th
        $tigapuluhtiga_tahun = \Carbon\Carbon::today()->subYears(33)->format('Y-m-d');
        $umur33_lk = DataPenduduk::where('tanggallahir', '>', $tigapuluhempat_tahun)->where('tanggallahir', '<=', $tigapuluhtiga_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 32 Th
        $tigapuluhdua_tahun = \Carbon\Carbon::today()->subYears(32)->format('Y-m-d');
        $umur32_lk = DataPenduduk::where('tanggallahir', '>', $tigapuluhtiga_tahun)->where('tanggallahir', '<=', $tigapuluhdua_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 31 Th
        $tigapuluhsatu_tahun = \Carbon\Carbon::today()->subYears(31)->format('Y-m-d');
        $umur31_lk = DataPenduduk::where('tanggallahir', '>', $tigapuluhdua_tahun)->where('tanggallahir', '<=', $tigapuluhsatu_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 30 Th
        $tigapuluh_tahun = \Carbon\Carbon::today()->subYears(30)->format('Y-m-d');
        $umur30_lk = DataPenduduk::where('tanggallahir', '>', $tigapuluhsatu_tahun)->where('tanggallahir', '<=', $tigapuluh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 29 Th
        $duapuluhsembilan_tahun = \Carbon\Carbon::today()->subYears(29)->format('Y-m-d');
        $umur29_lk = DataPenduduk::where('tanggallahir', '>', $tigapuluh_tahun)->where('tanggallahir', '<=', $duapuluhsembilan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 28 Th
        $duapuluhdelapan_tahun = \Carbon\Carbon::today()->subYears(28)->format('Y-m-d');
        $umur28_lk = DataPenduduk::where('tanggallahir', '>', $duapuluhsembilan_tahun)->where('tanggallahir', '<=', $duapuluhdelapan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 27 Th
        $duapuluhtujuh_tahun = \Carbon\Carbon::today()->subYears(27)->format('Y-m-d');
        $umur27_lk = DataPenduduk::where('tanggallahir', '>', $duapuluhdelapan_tahun)->where('tanggallahir', '<=', $duapuluhtujuh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 26 Th
        $duapuluhenam_tahun = \Carbon\Carbon::today()->subYears(26)->format('Y-m-d');
        $umur26_lk = DataPenduduk::where('tanggallahir', '>', $duapuluhtujuh_tahun)->where('tanggallahir', '<=', $duapuluhenam_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 25 Th
        $duapuluhlima_tahun = \Carbon\Carbon::today()->subYears(25)->format('Y-m-d');
        $umur25_lk = DataPenduduk::where('tanggallahir', '>', $duapuluhenam_tahun)->where('tanggallahir', '<=', $duapuluhlima_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 24 Th
        $duapuluhempat_tahun = \Carbon\Carbon::today()->subYears(24)->format('Y-m-d');
        $umur24_lk = DataPenduduk::where('tanggallahir', '>', $duapuluhlima_tahun)->where('tanggallahir', '<=', $duapuluhempat_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 23 Th
        $duapuluhtiga_tahun = \Carbon\Carbon::today()->subYears(23)->format('Y-m-d');
        $umur23_lk = DataPenduduk::where('tanggallahir', '>', $duapuluhempat_tahun)->where('tanggallahir', '<=', $duapuluhtiga_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 22 Th
        $duapuluhdua_tahun = \Carbon\Carbon::today()->subYears(22)->format('Y-m-d');
        $umur22_lk = DataPenduduk::where('tanggallahir', '>', $duapuluhtiga_tahun)->where('tanggallahir', '<=', $duapuluhdua_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 21 Th
        $duapuluhsatu_tahun = \Carbon\Carbon::today()->subYears(21)->format('Y-m-d');
        $umur21_lk = DataPenduduk::where('tanggallahir', '>', $duapuluhdua_tahun)->where('tanggallahir', '<=', $duapuluhsatu_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 20 Th
        $duapuluh_tahun = \Carbon\Carbon::today()->subYears(20)->format('Y-m-d');
        $umur20_lk = DataPenduduk::where('tanggallahir', '>', $duapuluhsatu_tahun)->where('tanggallahir', '<=', $duapuluh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 19 Th
        $sembilanbelas_tahun = \Carbon\Carbon::today()->subYears(19)->format('Y-m-d');
        $umur19_lk = DataPenduduk::where('tanggallahir', '>', $duapuluh_tahun)->where('tanggallahir', '<=', $sembilanbelas_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 18 Th
        $delapanbelas_tahun = \Carbon\Carbon::today()->subYears(18)->format('Y-m-d');
        $umur18_lk = DataPenduduk::where('tanggallahir', '>', $sembilanbelas_tahun)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 17 Th
        $tujuhbelas_tahun = \Carbon\Carbon::today()->subYears(17)->format('Y-m-d');
        $umur17_lk = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuhbelas_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 16 Th
        $enambelas_tahun = \Carbon\Carbon::today()->subYears(16)->format('Y-m-d');
        $umur16_lk = DataPenduduk::where('tanggallahir', '>', $tujuhbelas_tahun)->where('tanggallahir', '<=', $enambelas_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 15 Th
        $limabelas_tahun = \Carbon\Carbon::today()->subYears(15)->format('Y-m-d');
        $umur15_lk = DataPenduduk::where('tanggallahir', '>', $enambelas_tahun)->where('tanggallahir', '<=', $limabelas_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 14 Th
        $empatbelas_tahun = \Carbon\Carbon::today()->subYears(14)->format('Y-m-d');
        $umur14_lk = DataPenduduk::where('tanggallahir', '>', $limabelas_tahun)->where('tanggallahir', '<=', $empatbelas_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 13 Th
        $tigabelas_tahun = \Carbon\Carbon::today()->subYears(13)->format('Y-m-d');
        $umur13_lk = DataPenduduk::where('tanggallahir', '>', $empatbelas_tahun)->where('tanggallahir', '<=', $tigabelas_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 12 Th
        $duabelas_tahun = \Carbon\Carbon::today()->subYears(12)->format('Y-m-d');
        $umur12_lk = DataPenduduk::where('tanggallahir', '>', $tigabelas_tahun)->where('tanggallahir', '<=', $duabelas_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 11 Th
        $sebelas_tahun = \Carbon\Carbon::today()->subYears(11)->format('Y-m-d');
        $umur11_lk = DataPenduduk::where('tanggallahir', '>', $duabelas_tahun)->where('tanggallahir', '<=', $sebelas_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 10 Th
        $sepuluh_tahun = \Carbon\Carbon::today()->subYears(10)->format('Y-m-d');
        $umur10_lk = DataPenduduk::where('tanggallahir', '>', $sebelas_tahun)->where('tanggallahir', '<=', $sepuluh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 9 Th
        $sembilan_tahun = \Carbon\Carbon::today()->subYears(9)->format('Y-m-d');
        $umur9_lk = DataPenduduk::where('tanggallahir', '>', $sepuluh_tahun)->where('tanggallahir', '<=', $sembilan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 8 Th
        $delapan_tahun = \Carbon\Carbon::today()->subYears(8)->format('Y-m-d');
        $umur8_lk = DataPenduduk::where('tanggallahir', '>', $sembilan_tahun)->where('tanggallahir', '<=', $delapan_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 7 Th
        $tujuh_tahun = \Carbon\Carbon::today()->subYears(7)->format('Y-m-d');
        $umur7_lk = DataPenduduk::where('tanggallahir', '>', $delapan_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 6 Th
        $enam_tahun = \Carbon\Carbon::today()->subYears(6)->format('Y-m-d');
        $umur6_lk = DataPenduduk::where('tanggallahir', '>', $tujuh_tahun)->where('tanggallahir', '<=', $enam_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 5 Th
        $lima_tahun = \Carbon\Carbon::today()->subYears(5)->format('Y-m-d');
        $umur5_lk = DataPenduduk::where('tanggallahir', '>', $enam_tahun)->where('tanggallahir', '<=', $lima_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 4 Th
        $empat_tahun = \Carbon\Carbon::today()->subYears(4)->format('Y-m-d');
        $umur4_lk = DataPenduduk::where('tanggallahir', '>', $lima_tahun)->where('tanggallahir', '<=', $empat_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 3 Th
        $tiga_tahun = \Carbon\Carbon::today()->subYears(3)->format('Y-m-d');
        $umur3_lk = DataPenduduk::where('tanggallahir', '>', $empat_tahun)->where('tanggallahir', '<=', $tiga_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 2 Th
        $dua_tahun = \Carbon\Carbon::today()->subYears(2)->format('Y-m-d');
        $umur2_lk = DataPenduduk::where('tanggallahir', '>', $tiga_tahun)->where('tanggallahir', '<=', $dua_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 1 Th
        $satu_tahun = \Carbon\Carbon::today()->subYears(1)->format('Y-m-d');
        $umur1_lk = DataPenduduk::where('tanggallahir', '>', $dua_tahun)->where('tanggallahir', '<=', $satu_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Umur 0 Th
        $bawah1th_tahun = \Carbon\Carbon::today()->subYears(0)->format('Y-m-d');
        $umur0_lk = DataPenduduk::where('tanggallahir', '>', $satu_tahun)->where('tanggallahir', '<=', $bawah1th_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        // Total
        $total_lk = DataPenduduk::where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Perempuan
        // Atas Umur 75 Th
        $umur75atas_pr = DataPenduduk::where('tanggallahir', '<=', $tujuhpuluhlimaatas_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 75 Th
        $umur75_pr = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhlimaatas_tahun)->where('tanggallahir', '<=', $tujuhpuluhlima_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 74 Th
        $umur74_pr = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhlima_tahun)->where('tanggallahir', '<=', $tujuhpuluhempat_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 73 Th
        $umur73_pr = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhempat_tahun)->where('tanggallahir', '<=', $tujuhpuluhtiga_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 72 Th
        $umur72_pr = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhtiga_tahun)->where('tanggallahir', '<=', $tujuhpuluhdua_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 71 Th
        $umur71_pr = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhdua_tahun)->where('tanggallahir', '<=', $tujuhpuluhsatu_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 70 Th
        $umur70_pr = DataPenduduk::where('tanggallahir', '>', $tujuhpuluhsatu_tahun)->where('tanggallahir', '<=', $tujuhpuluh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 69 Th
        $umur69_pr = DataPenduduk::where('tanggallahir', '>', $tujuhpuluh_tahun)->where('tanggallahir', '<=', $enampuluhsembilan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 68 Th
        $umur68_pr = DataPenduduk::where('tanggallahir', '>', $enampuluhsembilan_tahun)->where('tanggallahir', '<=', $enampuluhdelapan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 67 Th
        $umur67_pr = DataPenduduk::where('tanggallahir', '>', $enampuluhdelapan_tahun)->where('tanggallahir', '<=', $enampuluhtujuh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 66 Th
        $umur66_pr = DataPenduduk::where('tanggallahir', '>', $enampuluhtujuh_tahun)->where('tanggallahir', '<=', $enampuluhenam_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 65 Th
        $umur65_pr = DataPenduduk::where('tanggallahir', '>', $enampuluhenam_tahun)->where('tanggallahir', '<=', $enampuluhlima_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 64 Th
        $umur64_pr = DataPenduduk::where('tanggallahir', '>', $enampuluhlima_tahun)->where('tanggallahir', '<=', $enampuluhempat_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 63 Th
        $umur63_pr = DataPenduduk::where('tanggallahir', '>', $enampuluhempat_tahun)->where('tanggallahir', '<=', $enampuluhtiga_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 62 Th
        $umur62_pr = DataPenduduk::where('tanggallahir', '>', $enampuluhtiga_tahun)->where('tanggallahir', '<=', $enampuluhdua_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 61 Th
        $umur61_pr = DataPenduduk::where('tanggallahir', '>', $enampuluhdua_tahun)->where('tanggallahir', '<=', $enampuluhsatu_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 60 Th
        $umur60_pr = DataPenduduk::where('tanggallahir', '>', $enampuluhsatu_tahun)->where('tanggallahir', '<=', $enampuluh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 59 Th
        $umur59_pr = DataPenduduk::where('tanggallahir', '>', $enampuluh_tahun)->where('tanggallahir', '<=', $limapuluhsembilan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 58 Th
        $umur58_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhsembilan_tahun)->where('tanggallahir', '<=', $limapuluhdelapan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 57 Th
        $umur57_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhdelapan_tahun)->where('tanggallahir', '<=', $limapuluhtujuh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 56 Th
        $umur56_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhtujuh_tahun)->where('tanggallahir', '<=', $limapuluhenam_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 55 Th
        $umur55_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhenam_tahun)->where('tanggallahir', '<=', $limapuluhlima_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 54 Th
        $umur54_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhlima_tahun)->where('tanggallahir', '<=', $limapuluhempat_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 53 Th
        $umur53_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhempat_tahun)->where('tanggallahir', '<=', $limapuluhtiga_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 52 Th
        $umur52_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhtiga_tahun)->where('tanggallahir', '<=', $limapuluhdua_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 51 Th
        $umur51_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhdua_tahun)->where('tanggallahir', '<=', $limapuluhsatu_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 50 Th
        $umur50_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhsatu_tahun)->where('tanggallahir', '<=', $limapuluh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 49 Th
        $umur49_pr = DataPenduduk::where('tanggallahir', '>', $limapuluh_tahun)->where('tanggallahir', '<=', $empatpuluhsembilan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 48 Th
        $umur48_pr = DataPenduduk::where('tanggallahir', '>', $empatpuluhsembilan_tahun)->where('tanggallahir', '<=', $empatpuluhdelapan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 47 Th
        $umur47_pr = DataPenduduk::where('tanggallahir', '>', $empatpuluhdelapan_tahun)->where('tanggallahir', '<=', $empatpuluhtujuh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 46 Th
        $umur46_pr = DataPenduduk::where('tanggallahir', '>', $empatpuluhtujuh_tahun)->where('tanggallahir', '<=', $empatpuluhenam_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 45 Th
        $umur45_pr = DataPenduduk::where('tanggallahir', '>', $empatpuluhenam_tahun)->where('tanggallahir', '<=', $empatpuluhlima_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 44 Th
        $umur44_pr = DataPenduduk::where('tanggallahir', '>', $empatpuluhlima_tahun)->where('tanggallahir', '<=', $empatpuluhempat_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 43 Th
        $umur43_pr = DataPenduduk::where('tanggallahir', '>', $empatpuluhempat_tahun)->where('tanggallahir', '<=', $empatpuluhtiga_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 42 Th
        $umur42_pr = DataPenduduk::where('tanggallahir', '>', $empatpuluhtiga_tahun)->where('tanggallahir', '<=', $empatpuluhdua_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 41 Th
        $umur41_pr = DataPenduduk::where('tanggallahir', '>', $empatpuluhdua_tahun)->where('tanggallahir', '<=', $empatpuluhsatu_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 40 Th
        $umur40_pr = DataPenduduk::where('tanggallahir', '>', $empatpuluhsatu_tahun)->where('tanggallahir', '<=', $empatpuluh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 39 Th
        $umur39_pr = DataPenduduk::where('tanggallahir', '>', $empatpuluh_tahun)->where('tanggallahir', '<=', $tigapuluhsembilan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 38 Th
        $umur38_pr = DataPenduduk::where('tanggallahir', '>', $tigapuluhsembilan_tahun)->where('tanggallahir', '<=', $tigapuluhdelapan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 37 Th
        $umur37_pr = DataPenduduk::where('tanggallahir', '>', $tigapuluhdelapan_tahun)->where('tanggallahir', '<=', $tigapuluhtujuh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 36 Th
        $umur36_pr = DataPenduduk::where('tanggallahir', '>', $tigapuluhtujuh_tahun)->where('tanggallahir', '<=', $tigapuluhenam_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 35 Th
        $umur35_pr = DataPenduduk::where('tanggallahir', '>', $tigapuluhenam_tahun)->where('tanggallahir', '<=', $tigapuluhlima_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 34 Th
        $umur34_pr = DataPenduduk::where('tanggallahir', '>', $tigapuluhlima_tahun)->where('tanggallahir', '<=', $tigapuluhempat_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 33 Th
        $umur33_pr = DataPenduduk::where('tanggallahir', '>', $tigapuluhempat_tahun)->where('tanggallahir', '<=', $tigapuluhtiga_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 32 Th
        $umur32_pr = DataPenduduk::where('tanggallahir', '>', $tigapuluhtiga_tahun)->where('tanggallahir', '<=', $tigapuluhdua_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 31 Th
        $umur31_pr = DataPenduduk::where('tanggallahir', '>', $tigapuluhdua_tahun)->where('tanggallahir', '<=', $tigapuluhsatu_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 30 Th
        $umur30_pr = DataPenduduk::where('tanggallahir', '>', $tigapuluhsatu_tahun)->where('tanggallahir', '<=', $tigapuluh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 29 Th
        $umur29_pr = DataPenduduk::where('tanggallahir', '>', $tigapuluh_tahun)->where('tanggallahir', '<=', $duapuluhsembilan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 28 Th
        $umur28_pr = DataPenduduk::where('tanggallahir', '>', $duapuluhsembilan_tahun)->where('tanggallahir', '<=', $duapuluhdelapan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 27 Th
        $umur27_pr = DataPenduduk::where('tanggallahir', '>', $duapuluhdelapan_tahun)->where('tanggallahir', '<=', $duapuluhtujuh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 26 Th
        $umur26_pr = DataPenduduk::where('tanggallahir', '>', $duapuluhtujuh_tahun)->where('tanggallahir', '<=', $duapuluhenam_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 25 Th
        $umur25_pr = DataPenduduk::where('tanggallahir', '>', $duapuluhenam_tahun)->where('tanggallahir', '<=', $duapuluhlima_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 24 Th
        $umur24_pr = DataPenduduk::where('tanggallahir', '>', $duapuluhlima_tahun)->where('tanggallahir', '<=', $duapuluhempat_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 23 Th
        $umur23_pr = DataPenduduk::where('tanggallahir', '>', $duapuluhempat_tahun)->where('tanggallahir', '<=', $duapuluhtiga_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 22 Th
        $umur22_pr = DataPenduduk::where('tanggallahir', '>', $duapuluhtiga_tahun)->where('tanggallahir', '<=', $duapuluhdua_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 21 Th
        $umur21_pr = DataPenduduk::where('tanggallahir', '>', $duapuluhdua_tahun)->where('tanggallahir', '<=', $duapuluhsatu_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 20 Th
        $umur20_pr = DataPenduduk::where('tanggallahir', '>', $duapuluhsatu_tahun)->where('tanggallahir', '<=', $duapuluh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 19 Th
        $umur19_pr = DataPenduduk::where('tanggallahir', '>', $duapuluh_tahun)->where('tanggallahir', '<=', $sembilanbelas_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 18 Th
        $umur18_pr = DataPenduduk::where('tanggallahir', '>', $sembilanbelas_tahun)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 17 Th
        $umur17_pr = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuhbelas_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 16 Th
        $umur16_pr = DataPenduduk::where('tanggallahir', '>', $tujuhbelas_tahun)->where('tanggallahir', '<=', $enambelas_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 15 Th
        $umur15_pr = DataPenduduk::where('tanggallahir', '>', $enambelas_tahun)->where('tanggallahir', '<=', $limabelas_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 14 Th
        $umur14_pr = DataPenduduk::where('tanggallahir', '>', $limabelas_tahun)->where('tanggallahir', '<=', $empatbelas_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 13 Th
        $umur13_pr = DataPenduduk::where('tanggallahir', '>', $empatbelas_tahun)->where('tanggallahir', '<=', $tigabelas_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 12 Th
        $umur12_pr = DataPenduduk::where('tanggallahir', '>', $tigabelas_tahun)->where('tanggallahir', '<=', $duabelas_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 11 Th
        $umur11_pr = DataPenduduk::where('tanggallahir', '>', $duabelas_tahun)->where('tanggallahir', '<=', $sebelas_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 10 Th
        $umur10_pr = DataPenduduk::where('tanggallahir', '>', $sebelas_tahun)->where('tanggallahir', '<=', $sepuluh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 9 Th
        $umur9_pr = DataPenduduk::where('tanggallahir', '>', $sepuluh_tahun)->where('tanggallahir', '<=', $sembilan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 8 Th
        $umur8_pr = DataPenduduk::where('tanggallahir', '>', $sembilan_tahun)->where('tanggallahir', '<=', $delapan_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 7 Th
        $umur7_pr = DataPenduduk::where('tanggallahir', '>', $delapan_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 6 Th
        $umur6_pr = DataPenduduk::where('tanggallahir', '>', $tujuh_tahun)->where('tanggallahir', '<=', $enam_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 5 Th
        $umur5_pr = DataPenduduk::where('tanggallahir', '>', $enam_tahun)->where('tanggallahir', '<=', $lima_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 4 Th
        $umur4_pr = DataPenduduk::where('tanggallahir', '>', $lima_tahun)->where('tanggallahir', '<=', $empat_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 3 Th
        $umur3_pr = DataPenduduk::where('tanggallahir', '>', $empat_tahun)->where('tanggallahir', '<=', $tiga_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 2 Th
        $umur2_pr = DataPenduduk::where('tanggallahir', '>', $tiga_tahun)->where('tanggallahir', '<=', $dua_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 1 Th
        $umur1_pr = DataPenduduk::where('tanggallahir', '>', $dua_tahun)->where('tanggallahir', '<=', $satu_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Umur 0 Th
        $umur0_pr = DataPenduduk::where('tanggallahir', '>', $satu_tahun)->where('tanggallahir', '<=', $bawah1th_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // Total
        $total_pr = DataPenduduk::where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        // -------------------------------------------------------------------------------------------------------------------
        // Tenaga Kerja
        // Laki Laki
        // Penduduk Usia 56 Tahun ke atas
        $penduduk56tahunatas_lk = DataPenduduk::where('tanggallahir', '<=', $limapuluhenam_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Penduduk usia 18 - 56 tahun yang belum/tidak bekerja
        $penduduktidakbekerja_lk = DataPenduduk::where('tanggallahir', '>', $penduduk56tahunatas_lk)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('jenispekerjaan_id', '1')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Penduduk usia 18 - 56 tahun yang bekerja
        $pendudukbekerja_lk = DataPenduduk::where('tanggallahir', '>', $penduduk56tahunatas_lk)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('jenispekerjaan_id', '>=', '5')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        ...
        $penduduksd_lk = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '4')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        $pendudukslba_lk = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '14')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Penduduk usia 7 - 18 tahun yang masih sekolah (SMP)
        $penduduksmp_lk = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '6')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        $pendudukslbb_lk = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '15')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Penduduk usia 7 - 18 tahun yang masih sekolah (SMA)
        $penduduksma_lk = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '7')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        $pendudukslbc_lk = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '16')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();
        ...
        $pendudukusia0tahun_lk = DataPenduduk::where('tanggallahir', '>', $enam_tahun)->where('tanggallahir', '<=', $bawah1th_tahun)->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Tenaga Kerja
        // Perempuan
        // Penduduk Usia 56 Tahun ke atas
        $penduduk56tahunatas_pr = DataPenduduk::where('tanggallahir', '<=', $limapuluhenam_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Penduduk usia 18 - 56 tahun yang belum/tidak bekerja
        $penduduktidakbekerja_pr = DataPenduduk::where('tanggallahir', '>', $penduduk56tahunatas_pr)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('jenispekerjaan_id', '1')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Penduduk usia 18 - 56 tahun yang bekerja
        $pendudukbekerja_pr = DataPenduduk::where('tanggallahir', '>', $penduduk56tahunatas_pr)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('jenispekerjaan_id', '>=', '5')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Penduduk usia 18 - 56 tahun (a + b)
        $totalpendudukbekerja_pr = $pendudukbekerja_pr + $penduduktidakbekerja_pr;

        // Penduduk usia 7 - 18 tahun yang masih sekolah (SD)
        $penduduksd_pr = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '4')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        $pendudukslba_pr = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '14')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Penduduk usia 7 - 18 tahun yang masih sekolah (SMP)
        $penduduksmp_pr = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '6')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        $pendudukslbb_pr = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '15')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Penduduk usia 7 - 18 tahun yang masih sekolah (SMA)
        $penduduksma_pr = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '7')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();
        $pendudukslbc_pr = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '16')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Total Penduduk usia 7 - 18 tahun yang masih sekolah
        $totalpenduduksekolah_pr = $penduduksd_pr + $penduduksmp_pr + $penduduksma_pr + $pendudukslba_pr + $pendudukslbc_pr + $pendudukslbc_pr;

        // Penduduk usia 0 - 6 tahun
        $pendudukusia0tahun_pr = DataPenduduk::where('tanggallahir', '>', $enam_tahun)->where('tanggallahir', '<=', $bawah1th_tahun)->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Kualitas Angkatan Kerja
        // Laki-Laki
        // Penduduk usia 18 - 56 tahun yang buta aksara dan huruf/angka latin
        $kualitas_pdk_ba_dewasa_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhenam_tahun)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('pendidikan_sedang_id', '29')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Usia 3-6 tahun yang belum masuk play group/TK
        $kualitas_pdk_btk_anak_lk = DataPenduduk::where('tanggallahir', '>', $enam_tahun)->where('tanggallahir', '<=', $tiga_tahun)->where('pendidikan_sedang_id', '1')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Usia 3-6 tahun yang sedang play group/TK
        $kualitas_pdk_mtk_anak_lk = DataPenduduk::where('tanggallahir', '>', $enam_tahun)->where('tanggallahir', '<=', $tiga_tahun)->where('pendidikan_sedang_id', '2')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Usia 7-18 tahun yang tidak pernah sekolah
        $kualitas_pdk_remaja_lk = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '3')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Usia 7-18 tahun yang sedang sekolah
        //
        // Usia 18-56 tahun tidak pernah sekolah
        $kualitas_pdk_tps_dewasa_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhenam_tahun)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('pendidikan_sedang_id', '3')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Usia 18-56 tahun tidak tamat SD
        $kualitas_pdk_ttsd_dewasa_lk = DataPenduduk::where('tanggallahir', '>', $limapuluhenam_tahun)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('pendidikan_sedang_id', '5')->where('jeniskelamin_id', '1')->where('desa_id', $desa_id)->count();

        // Kualitas Angkatan Kerja
        // Perempuan
        // Penduduk usia 18 - 56 tahun yang buta aksara dan huruf/angka latin
        $kualitas_pdk_ba_dewasa_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhenam_tahun)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('pendidikan_sedang_id', '29')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Usia 3-6 tahun yang belum masuk play group/TK
        $kualitas_pdk_btk_anak_pr = DataPenduduk::where('tanggallahir', '>', $enam_tahun)->where('tanggallahir', '<=', $tiga_tahun)->where('pendidikan_sedang_id', '1')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Usia 3-6 tahun yang sedang play group/TK
        $kualitas_pdk_mtk_anak_pr = DataPenduduk::where('tanggallahir', '>', $enam_tahun)->where('tanggallahir', '<=', $tiga_tahun)->where('pendidikan_sedang_id', '2')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Usia 7-18 tahun yang tidak pernah sekolah
        $kualitas_pdk_remaja_pr = DataPenduduk::where('tanggallahir', '>', $delapanbelas_tahun)->where('tanggallahir', '<=', $tujuh_tahun)->where('pendidikan_sedang_id', '3')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Usia 7-18 tahun yang sedang sekolah
        //
        // Usia 18-56 tahun tidak pernah sekolah
        $kualitas_pdk_tps_dewasa_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhenam_tahun)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('pendidikan_sedang_id', '3')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        // Usia 18-56 tahun tidak tamat SD
        $kualitas_pdk_ttsd_dewasa_pr = DataPenduduk::where('tanggallahir', '>', $limapuluhenam_tahun)->where('tanggallahir', '<=', $delapanbelas_tahun)->where('pendidikan_sedang_id', '5')->where('jeniskelamin_id', '2')->where('desa_id', $desa_id)->count();

        $agama_id = Agama::ambilSemua();
        $jumlahaparaturdesa = AparaturDesa::where('desa_id', $desa_id)->get();
        $kades = PerangkatDesa::where('desa_id', $desa_id)->where('jabatan', 'Kepala Desa/Lurah')->get();
        $sekdes = PerangkatDesa::where('desa_id', $desa_id)->where('jabatan', 'Sekretaris Desa')->get();
        $seksipem = PerangkatDesa::where('desa_id', $desa_id)->where('jabatan', 'Kepala Seksi Pemerintahan')->get();
        $seksikesra = PerangkatDesa::where('desa_id', $desa_id)->where('jabatan', 'Kepala Seksi Kesejahteraan Rakyat')->get();
        $seksipel = PerangkatDesa::where('desa_id', $desa_id)->where('jabatan', 'Kepala Seksi Pelayanan')->get();
        $seksitu = PerangkatDesa::where('desa_id', $desa_id)->where('jabatan', 'Kepala Urusan Tata Usaha dan Umum')->get();
        $seksikeu = PerangkatDesa::where('desa_id', $desa_id)->where('jabatan', 'Kepala Urusan Keuangan')->get();
        $seksiren = PerangkatDesa::where('desa_id', $desa_id)->where('jabatan', 'Kepala Urusan Perencanaan')->get();
        $bpdketua = BPD::where('desa_id', $desa_id)->where('jabatan', 'Ketua')->get();
        $bpdwaket = BPD::where('desa_id', $desa_id)->where('jabatan', 'Wakil Ketua')->get();
        $bpdsekr = BPD::where('desa_id', $desa_id)->where('jabatan', 'Sekretaris')->get();
        $bpdanggota = BPD::where('desa_id', $desa_id)->where('jabatan', 'Anggota')->get();
        $jumlahagtbpd = BPD::where('desa_id', $desa_id)->count();
        $jumlahstafdesa = PerangkatDesa::where('desa_id', $desa_id)->where('jabatan', 'Staf')->count();
        $jumlahperangkatdesa = PerangkatDesa::where('desa_id', $desa_id)->count();
        $pendidikanformal = PendidikanFormal::where('desa_id', $desa_id)->get();
        $pendidikankeagamaan1 = PendidikanKeagamaan::where('desa_id', $desa_id)->where('kategoripendidikan', 'Sekolah Islam')->get();
        $pendidikankeagamaan2 = PendidikanKeagamaan::where('desa_id', $desa_id)->where('kategoripendidikan', 'Sekolah Katholik')->get();
        $pendidikankeagamaan3 = PendidikanKeagamaan::where('desa_id', $desa_id)->where('kategoripendidikan', 'Sekolah Budha')->get();
        $pendidikankeagamaan4 = PendidikanKeagamaan::where('desa_id', $desa_id)->where('kategoripendidikan', 'Sekolah Protestan')->get();
        $pendidikankeagamaan5 = PendidikanKeagamaan::where('desa_id', $desa_id)->where('kategoripendidikan', 'Sekolah Hindu')->get();
        $pendidikankeagamaan6 = PendidikanKeagamaan::where('desa_id', $desa_id)->where('kategoripendidikan', 'Sekolah Konghucu')->get();
        $pendidikannonformal = PendidikanNonFormal::where('desa_id', $desa_id)->get();
        $lembagakemasyarakatan = LembagaKemasyarakatan::where('desa_id', $desa_id)->get();
        $tingkatpartisipasipolitik = TingkatPartisipasiPolitik::where('desa_id', $desa_id)->get();
        $profildesa = Desa::where('id', $desa_id)->get();
        $lembagaekonomi = LembagaEkonomi::where('desa_id', $desa_id)->get();
        $jasalembagakeuangan = JasaLembagaKeuangan::where('desa_id', $desa_id)->get();
        $industrikecil = IndustriKecil::where('desa_id', $desa_id)->get();
        $usahajasapengangkutan1 = UsahaJasaPengangkutan::where('desa_id', $desa_id)->where('kategorijasapengangkutan', 'Angkutan Darat')->get();
        $usahajasapengangkutan2 = UsahaJasaPengangkutan::where('desa_id', $desa_id)->where('kategorijasapengangkutan', 'Angkutan Sungai')->get();
        $usahajasapengangkutan3 = UsahaJasaPengangkutan::where('desa_id', $desa_id)->where('kategorijasapengangkutan', 'Angkutan Laut')->get();
        $usahajasapengangkutan4 = UsahaJasaPengangkutan::where('desa_id', $desa_id)->where('kategorijasapengangkutan', 'Angkutan Udara')->get();
        $usahajasapengangkutan5 = UsahaJasaPengangkutan::where('desa_id', $desa_id)->where('kategorijasapengangkutan', 'Ekspedisi dan Pengiriman')->get();
        $usahajasaperdagangan = UsahaJasaPerdagangan::where('desa_id', $desa_id)->get();
        $usahajasahiburan = UsahaJasaHiburan::where('desa_id', $desa_id)->get();
        $usahajasagas = UsahaJasaGas::where('desa_id', $desa_id)->get();
        $usahajasaketerampilan = UsahaJasaKeterampilan::where('desa_id', $desa_id)->get();
        $usahajasahukum = UsahaJasaHukum::where('desa_id', $desa_id)->get();
        $usahajasapenginapan = UsahaJasaPenginapan::where('desa_id', $desa_id)->get();
        $kadus = Alamat::where('desa_id', $desa_id)->get();
        $jumlahdusun = Alamat::where('desa_id', $desa_id)->count();
        ...
        $jml_etn_lk1 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '1')->count();
        $jml_etn_lk2 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '2')->count();
        $jml_etn_lk3 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '3')->count();
        $jml_etn_lk4 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '4')->count();
        $jml_etn_lk5 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '5')->count();
        $jml_etn_lk6 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '6')->count();
        $jml_etn_lk7 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '7')->count();
        $jml_etn_lk8 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '8')->count();
        $jml_etn_lk9 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '9')->count();
        $jml_etn_lk10 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '10')->count();
        $jml_etn_lk11 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '11')->count();
        $jml_etn_lk12 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '12')->count();
        $jml_etn_lk13 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '13')->count();
        $jml_etn_lk14 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '14')->count();
        $jml_etn_lk15 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('etnis_id', '15')->count();

        $jml_etn_pr1 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '1')->count();
        $jml_etn_pr2 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '2')->count();
        $jml_etn_pr3 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '3')->count();
        $jml_etn_pr4 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '4')->count();
        $jml_etn_pr5 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '5')->count();
        $jml_etn_pr6 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '6')->count();
        $jml_etn_pr7 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '7')->count();
        $jml_etn_pr8 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '8')->count();
        $jml_etn_pr9 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '9')->count();
        $jml_etn_pr10 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '10')->count();
        $jml_etn_pr11 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '11')->count();
        $jml_etn_pr12 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '12')->count();
        $jml_etn_pr13 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '13')->count();
        $jml_etn_pr14 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '14')->count();
        $jml_etn_pr15 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('etnis_id', '15')->count();
        ...
        $jml_wrg_lk1 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('kewarganegaraan_id', '1')->count();
        $jml_wrg_pr1 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('kewarganegaraan_id', '1')->count();
        $jml_wrg_lk2 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('kewarganegaraan_id', '2')->count();
        $jml_wrg_pr2 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('kewarganegaraan_id', '2')->count();

        $jml_pcct_lk1 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('penyandangcacat_id', '1')->count();
        $jml_pcct_lk2 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('penyandangcacat_id', '2')->count();
        $jml_pcct_lk3 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('penyandangcacat_id', '3')->count();
        $jml_pcct_lk4 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('penyandangcacat_id', '4')->count();
        $jml_pcct_lk5 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('penyandangcacat_id', '5')->count();
        $jml_pcct_lk6 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('penyandangcacat_id', '6')->count();
        $jml_pcct_lk7 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '1')->where('penyandangcacat_id', '7')->count();

        $jml_pcct_pr1 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('penyandangcacat_id', '1')->count();
        $jml_pcct_pr2 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('penyandangcacat_id', '2')->count();
        $jml_pcct_pr3 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('penyandangcacat_id', '3')->count();
        $jml_pcct_pr4 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('penyandangcacat_id', '4')->count();
        $jml_pcct_pr5 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('penyandangcacat_id', '5')->count();
        $jml_pcct_pr6 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('penyandangcacat_id', '6')->count();
        $jml_pcct_pr7 = DataPenduduk::where('desa_id', $desa_id)->where('jeniskelamin_id', '2')->where('penyandangcacat_id', '7')->count();

        return view('admin.profil-desa.edit', compact(
            'profilkecamatan',
            'lembagaekonomi',
            'jasalembagakeuangan',
            'industrikecil',
    ...
    public function updatePotensiUmum(Request $request, $desa_id)
    {
    ...
    public function updateDataTanah(Request $request, $desa_id)
    {
    ...
    public function updateIklimJenisKesuburanTanah(Request $request, $desa_id)
    {
    ...
    public function updateTopografiLetakOrbitasi(Request $request, $desa_id)
    {
    ...
    public function updateLembagaAdat(Request $request, $desa_id)
    {
    ...
    public function updateLembagaKeamanan(Request $request, $desa_id)
    {
    ...
    public function updatePrasaranaAirBersih(Request $request, $desa_id)
    {
    ...
    public function updatePrasaranaLKDK(Request $request, $desa_id)
    {
    ...
    public function updatePrasaranaPemerintahan(Request $request, $desa_id)
    {
    ...
    public function updatePrasaranaBPDDusun(Request $request, $desa_id)
    {
    ...
    public function updatePrasaranaIrigasi(Request $request, $desa_id)
    {
    ...
    public function updatePertanian(Request $request, $desa_id)
    {
    ...
    public function updatePemasaranPanganBuah(Request $request, $desa_id)
    {
    ...
    public function updatePemasaranHasilPerkebunan(Request $request, $desa_id)
    {
    ...
    public function updatePemasaranHasilHutan(Request $request, $desa_id)
    {
    ...
    public function updateSungai(Request $request, $desa_id)
    {
    ...
    public function updateRawa(Request $request, $desa_id)
    {
    ...
    public function updateManfaatKondisiDanau(Request $request, $desa_id)
    {
    ...
    public function updatePemasaranHasilGalian(Request $request, $desa_id)
    {
    ...
    public function updatePemasaranHasilIkan(Request $request, $desa_id)
    {
    ...
    public function updateKetersediaanLahanTernak(Request $request, $desa_id)
    {
    ...
    public function updatePemasaranHasilTernak(Request $request, $desa_id)
    {
    ...
    public function updateHijauanPakanTernak(Request $request, $desa_id)
    {
