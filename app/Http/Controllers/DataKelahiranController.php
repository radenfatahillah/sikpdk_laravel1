...
class DataKelahiranController extends Controller
{
    ...
    {
        $datakelahiran = DataKelahiran::ambilSemua();
        return view('admin.kelola-data.kelahiran.index', compact('datakelahiran'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.kelola-data.kelahiran.create', compact('jeniskelamin_id', 'desa_id', 'agama_id', 'etnis_id', 'golongandarah_id', 'alamat_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $datakelahiran->save();
        return redirect()->route('keloladata-datakelahiran.index');
    }
    ...
    public function show($id)
    {
        ...
        $golongandarah_id = GolonganDarah::ambilSemua();
        $alamat_id = Alamat::ambilSemua();
        return view('admin.kelola-data.kelahiran.show', compact('datakelahiran', 'desa_id', 'agama_id', 'jeniskelamin_id', 'golongandarah_id', 'alamat_id'));
    }
    ...
    public function edit($id)
    {
        ...
        $alamat_id = Alamat::ambilSemua();
        $datakelahiran = DataKelahiran::ambil($id);
        return view('admin.kelola-data.kelahiran.edit', compact('jeniskelamin_id', 'datakelahiran', 'desa_id', 'agama_id', 'etnis_id', 'golongandarah_id', 'alamat_id'));
    }
