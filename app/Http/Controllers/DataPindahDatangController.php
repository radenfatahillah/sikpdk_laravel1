...
class DataPindahDatangController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $pindahdatang = DataPindahDatang::ambilSemua();
        return view('admin.kelola-data.pindah-datang.index', compact('pindahdatang', 'today'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.kelola-data.pindah-datang.create', compact('klasifikasipindah_id', 'jeniskelamin_id', 'desa_id', 'agama_id', 'etnis_id', 'golongandarah_id', 'alamat_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $pindahdatang->save();
        return redirect()->route('keloladata-datapindahdatang.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.kelola-data.pindah-datang.show', compact('pindahdatang', 'klasifikasipindah_id', 'jeniskelamin_id', 'desa_id', 'agama_id', 'etnis_id', 'golongandarah_id', 'alamat_id'));
    }
    ...
    public function edit($id)
    {
        ...
        $klasifikasipindah_id = KlasifikasiPindah::ambilSemua();
        $pindahdatang = DataPindahDatang::ambil($id);
        return view('admin.kelola-data.pindah-datang.edit', compact('pindahdatang', 'klasifikasipindah_id', 'jeniskelamin_id', 'desa_id', 'agama_id', 'etnis_id', 'golongandarah_id', 'alamat_id'));
    }
