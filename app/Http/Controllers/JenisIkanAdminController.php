...
class JenisIkanAdminController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('admin.jenisikan.create', ['kgjenisikan' => $kgjenisikan, 'desa_id' => $desa_id]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $jenisikan->desa_id = $request->desa_id;
    ...
    public function edit($id)
    {
        ...
        return view('admin.jenisikan.edit', ['kgjenisikan' => $kgjenisikan, 'jenisikan' => $jenisikan]);
    }
    ...
    {
        $jenisikan = JenisIkan::ambil($id);
        $jenisikan->desa_id = $request->input('desa_id');
