...
class LembagaKemasyarakatanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('operatordesa.lembagakemasyarakatan.create', ['kglembagakemasyarakatan' => $kglembagakemasyarakatan]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $lembagakemasyarakatan->desa_id = auth()->user()->desa_id;
    ...
    public function edit($id)
    {
        ...
        return view('operatordesa.lembagakemasyarakatan.edit', ['kglembagakemasyarakatan' => $kglembagakemasyarakatan, 'lembagakemasyarakatan' => $lembagakemasyarakatan]);
    }
