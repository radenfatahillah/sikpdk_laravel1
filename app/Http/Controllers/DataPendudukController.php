...
class DataPendudukController extends Controller
{
    ...
    public function index()
    {
        ...
        $datapenduduk = DataPenduduk::orderBy('desa_id')->orderBy('rt')->orderBy('NOKK')->orderBy('shdk_id')->get();
        return view('admin.kelola-data.data-penduduk.index', compact('datapenduduk', 'today'));
    }
    ...
    public function create()
    {
        ...
        $alamat_id = Alamat::ambilSemua();
        $ktpel_id = KTPEl::ambilSemua();
        return view('admin.kelola-data.data-penduduk.create', compact('ktpel_id', 'jeniskelamin_id', 'desa_id', 'agama_id', 'etnis_id', 'pendidikan_kk_id', 'pendidikan_sedang_id', 'penyandangcacat_id', 'jenispekerjaan_id', 'golongandarah_id', 'statusperkawinan_id', 'shdk_id', 'kewarganegaraan_id', 'alamat_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $datapenduduk->save();
        return redirect()->route('keloladata-datapenduduk.index');
    }
    ...
    public function show($NIK)
    {
        ...
        return view('admin.kelola-data.data-penduduk.show', ['datapenduduk' => $datapenduduk]);
    }
    ...
    public function edit($NIK)
    {
        ...
        $ktpel_id = KTPEl::ambilSemua();
        $datapenduduk = DataPenduduk::ambil($NIK);
        return view('admin.kelola-data.data-penduduk.edit', compact('ktpel_id', 'jeniskelamin_id', 'datapenduduk', 'desa_id', 'agama_id', 'etnis_id', 'pendidikan_kk_id', 'pendidikan_sedang_id', 'penyandangcacat_id', 'jenispekerjaan_id', 'golongandarah_id', 'statusperkawinan_id', 'shdk_id', 'kewarganegaraan_id', 'alamat_id'));
    }
