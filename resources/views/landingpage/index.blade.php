    ...
    <div class="container">
        <div class="row gy-4 d-flex justify-content-between">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                ...
                <p data-aos="fade-up" data-aos-delay="100">Nomor Induk Kependudukan (NIK) adalah nomor identitas penduduk yang bersifat unik atau khas, tunggal dan melekat pada seseorang yang terdaftar sebagai Penduduk Indonesia. Cek NIK anda apakah terdaftar di Wilayah Kecamatan Teluk Keramat Kabupaten Sambas Sekarang Juga!</p>

                <form action="{{ route('landingpageceknik') }}" method="GET" class="form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
                    @csrf
                    <input type="text" class="form-control @error('body') is-invalid @enderror" name="NIK" placeholder="Masukkan NIK Anda" value="{{ old('NIK') }}">
                    <button type="submit" class="btn btn-primary">Cari</button>
                </form>
                <div class="bg-danger text-white form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
                    @if ($errors->has('NIK'))
                    <div class="container">
                        {{ $errors->first('NIK') }}
                    </div>
