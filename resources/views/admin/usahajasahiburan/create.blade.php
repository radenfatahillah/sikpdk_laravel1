    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">TAMBAH DATA USAHA JASA HIBURAN</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('usaha-jasa-hiburan-admin.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kgusahajasahiburan_id" class="form-control">
                                        <?php foreach ($kgusahajasahiburan as $kpd) : ?>
