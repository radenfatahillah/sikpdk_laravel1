    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form action="<?= route('ubah-desa.update', $desa['id']) ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name" name="name" value="<?= $desa->name ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="kode_desa" class="col-sm-3 text-end control-label col-form-label">Kode Desa</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="kode_desa" name="kode_desa" value="<?= $desa->kode_desa ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
