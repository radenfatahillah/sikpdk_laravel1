    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">TAMBAH DATA POTENSI WISATA</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('potensi-wisata-admin.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="kgpotensiwisata_id" class="col-sm-3 text-end control-label col-form-label">Lokasi/Tempat/Area Wisata</label>
                                <div class="col-sm-9">
                                    <select name="kgpotensiwisata_id" class="form-control">
                                        <?php foreach ($kgpotensiwisata as $kgt) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="luas" name="luas" placeholder="Contoh : 1">
                                </div>
                            </div>
                            <div class="form-group row">
