    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">TAMBAH DATA RUANG PUBLIK/TAMAN</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('ruang-publik-admin.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="kgruangpublik_id" class="col-sm-3 text-end control-label col-form-label">Lokasi/Tempat/Area Wisata</label>
                                <div class="col-sm-9">
                                    <select name="kgruangpublik_id" class="form-control">
                                        <?php foreach ($kgruangpublik as $kgt) : ?>
