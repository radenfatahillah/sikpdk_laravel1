    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">TAMBAH DATA KANTOR POS</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('kantorpos-admin.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kgkantorpos_id" class="form-control">
                                        <?php foreach ($kgkantorpos as $kkp) : ?>
                                            <option value="{{ $kkp->id }}">{{ $kkp->name }}</option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
