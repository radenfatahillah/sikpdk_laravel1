    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">TAMBAH DATA USAHA JASA PENGANGKUTAN</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('usaha-jasa-pengangkutan-admin.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kgusahajasapengangkutan_id" class="form-control">
                                        <?php foreach ($kgusahajasapengangkutan as $kpd) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kategorijasapengangkutan" class="form-control">
                                        <option value="Angkutan Darat">Angkutan Darat</option>
                                        <option value="Angkutan Sungai">Angkutan Sungai</option>
                                        <option value="Angkutan Laut">Angkutan Laut</option>
                                        <option value="Angkutan Udara">Angkutan Udara</option>
                                        <option value="Ekspedisi Dan Pengiriman">Ekspedisi Dan Pengiriman</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pemilik" name="pemilik" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="kapasitas" class="col-sm-3 text-end control-label col-form-label">Kapasitas (Orang)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="kapasitas" name="kapasitas" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="jumlah_tenagakerja" class="col-sm-3 text-end control-label col-form-label">Tenaga Kerja (Orang)</label>
                                <div class="col-sm-9">
