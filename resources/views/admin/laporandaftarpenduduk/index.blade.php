...
<script type="text/javascript">
    var jumlah_lk = <?php echo $jumlah_lk1; ?>;
    var jumlah_pr = <?php echo $jumlah_pr1; ?>;
    // Load google charts
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $des['name'] }}</td>
                                        <td>{{ $jumlahlakilaki = $jumlah_lk->where('desa_id', $des['id'])->count() }}</td>
                                        <td>{{ $jumlahperempuan = $jumlah_pr->where('desa_id', $des['id'])->count() }}</td>
                                        <td>{{ $jumlahlakilaki+$jumlahperempuan }}</td>
                                        <td>{{ $ktpel->where('desa_id', $des['id'])->count() }}</td>
                                        <td>{{ $wajibktp->where('desa_id', $des['id'])->count() }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
