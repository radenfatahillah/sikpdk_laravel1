    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">TAMBAH DATA PENDIDIKAN NON FORMAL/KURSUS</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('pendidikan-non-formal-admin.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="kgpendidikannonformal_id" class="col-sm-3 text-end control-label col-form-label">Jenis Pendidikan</label>
                                <div class="col-sm-9">
                                    <select name="kgpendidikannonformal_id" class="form-control">
                                        <?php foreach ($kgpendidikannonformal as $kgt) : ?>
