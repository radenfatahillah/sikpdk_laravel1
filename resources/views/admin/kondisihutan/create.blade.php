    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">TAMBAH DATA KONDISI HUTAN</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('kondisi-hutan-admin.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="kgkondisihutan_id" class="col-sm-3 text-end control-label col-form-label">Jenis Hutan</label>
                                <div class="col-sm-9">
                                    <select name="kgkondisihutan_id" class="form-control">
                                        <?php foreach ($kgkondisihutan as $kgt) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="baik" name="baik" placeholder="Contoh : 1">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="rusak" class="col-sm-3 text-end control-label col-form-label">Kondisi Rusak (Ha)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="rusak" name="rusak" placeholder="Contoh : 1">
                                </div>
                            </div>
                        </div>
