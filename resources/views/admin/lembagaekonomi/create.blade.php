    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('lembaga-ekonomi-admin.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="kegiatan" name="kegiatan" placeholder="Contoh : 1">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="pengurus" class="col-sm-3 text-end control-label col-form-label"> Jumlah Pengurus dan Anggota</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pengurus" name="pengurus" placeholder="Contoh : 1">
                                </div>
                            </div>
                        </div>
