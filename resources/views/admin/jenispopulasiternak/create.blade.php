    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('jenis-populasi-ternak-admin.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="jumlahpemilik" name="jumlahpemilik" placeholder="Contoh : 1">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="perkiraanjumlah" class="col-sm-3 text-end control-label col-form-label">Perkiraan Jumlah Populasi (Ekor)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="perkiraanjumlah" name="perkiraanjumlah" placeholder="Contoh : 1">
                                </div>
                            </div>
                        </div>
