    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('hasil-perkebunan.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="luasnegara" name="luasnegara" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="hasilnegara" class="col-sm-3 text-end control-label col-form-label">Hasil Panen Swasta/Negara (Ton/Ha)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="hasilnegara" name="hasilnegara" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="luasrakyat" class="col-sm-3 text-end control-label col-form-label">Luas Rakyat (Ha)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="luasrakyat" name="luasrakyat" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="hasilrakyat" class="col-sm-3 text-end control-label col-form-label">Hasil Panen Rakyat (Ton/Ha)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="hasilrakyat" name="hasilrakyat" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                        </div>
