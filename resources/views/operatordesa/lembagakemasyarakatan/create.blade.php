    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('lembaga-kemasyarakatan.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="jumlah_lembaga" name="jumlah_lembaga" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="jumlah_pengurus" class="col-sm-3 text-end control-label col-form-label">Jumlah Pengurus</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="jumlah_pengurus" name="jumlah_pengurus" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="ruang_lingkup_kegiatan" class="col-sm-3 text-end control-label col-form-label">Ruang Lingkup Kegiatan</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="ruang_lingkup_kegiatan" name="ruang_lingkup_kegiatan" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="jumlah_jenis_kegiatan" class="col-sm-3 text-end control-label col-form-label">Jumlah Jenis Kegiatan</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="jumlah_jenis_kegiatan" name="jumlah_jenis_kegiatan" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                        </div>
