    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">TAMBAH DATA LEMBAGA EKONOMI, DAN UNIT USAHA DESA/KELURAHAN</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('lembaga-ekonomi.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kglembagaekonomi_id" class="form-control">
                                        <?php foreach ($kglembagaekonomi as $kpd) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="kegiatan" name="kegiatan" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="pengurus" class="col-sm-3 text-end control-label col-form-label"> Jumlah Pengurus dan Anggota</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pengurus" name="pengurus" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                        </div>
