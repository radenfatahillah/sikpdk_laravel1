                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                <form action="<?= route('profil-desa.updatePotensiUmum', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PATCH')}}
                            ...
                            <div class="accordion-item">
                                <form action="<?= route('profil-desa.updateDataTanah', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PATCH')}}
                            ...
                            <div class="accordion-item">
                                <form action="<?= route('profil-desa.updateIklimJenisKesuburanTanah', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PATCH')}}
                                    <h2 class="accordion-header">
                            ...
                            <div class="accordion-item">
                                <form action="<?= route('profil-desa.updateTopografiLetakOrbitasi', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PATCH')}}
                                    <h2 class="accordion-header">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <form action="<?= route('profil-desa.updatePertanian', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            {{ method_field('PATCH')}}
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('kehutanan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('kehutanan.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('kehutanan.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('tanaman-pangan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('tanaman-pangan.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('tanaman-pangan.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('komoditas-buah.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('komoditas-buah.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('komoditas-buah.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <form action="<?= route('profil-desa.updatePemasaranPanganBuah', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{ method_field('PATCH')}}
                                        <div class="form-group row">
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('tanaman-apotik.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('tanaman-apotik.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('tanaman-apotik.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('hasil-perkebunan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('hasil-perkebunan.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('hasil-perkebunan.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <form action="<?= route('profil-desa.updatePemasaranHasilPerkebunan', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{ method_field('PATCH')}}
                                        <div class="form-group row">
                                    ...
                                    <a href="<?= route('hasil-hutan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('hasil-hutan.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('hasil-hutan.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('kondisi-hutan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('kondisi-hutan.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('kondisi-hutan.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('dampak-olah-hutan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('dampak-olah-hutan.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('dampak-olah-hutan.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <form action="<?= route('profil-desa.updatePemasaranHasilHutan', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{ method_field('PATCH')}}
                                        <div class="form-group row">
                                    ...
                                    <a href="<?= route('jenis-populasi-ternak.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('jenis-populasi-ternak.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('jenis-populasi-ternak.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('produksi-ternak.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('produksi-ternak.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('produksi-ternak.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <form action="<?= route('profil-desa.updateHijauanPakanTernak', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{ method_field('PATCH')}}
                                        <div class="form-group row">
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('pemilik-usaha-ternak.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('pemilik-usaha-ternak.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('pemilik-usaha-ternak.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <form action="<?= route('profil-desa.updatePemasaranHasilTernak', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{ method_field('PATCH')}}
                                        <div class="form-group row">
                                    ...
                                    <form action="<?= route('profil-desa.updateKetersediaanLahanTernak', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{ method_field('PATCH')}}
                                        <div class="form-group row">
                                    ...
                                    <a href="<?= route('alat-produksi-laut.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('alat-produksi-laut.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('alat-produksi-laut.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('alat-produksi-tawar.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('alat-produksi-tawar.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('alat-produksi-tawar.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <div class="border-top">
                                        ...
                                        <a href="<?= route('jenis-ikan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group row">
                                                            <div class="col-sm-2">
                                                                <a href="<?= route('jenis-ikan.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <form action="<?= route('jenis-ikan.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                                </form>
                                    ...
                                    <form action="<?= route('profil-desa.updatePemasaranHasilIkan', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{ method_field('PATCH')}}
                                        <div class="form-group row">
                                ...
                                <a href="<?= route('bahan-galian.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('bahan-galian.edit', $htna['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('bahan-galian.destroy', $htna['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <form action="<?= route('profil-desa.updatePemasaranHasilGalian', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PATCH')}}
                                    <div class="form-group row">
                                ...
                                <a href="<?= route('potensi-air-sda.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('potensi-air-sda.edit', $kud['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('potensi-air-sda.destroy', $kud['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('sumber-air-bersih.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('sumber-air-bersih.edit', $kud['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('sumber-air-bersih.destroy', $kud['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <form action="<?= route('profil-desa.updateSungai', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PATCH')}}
                                    <div class="form-group row">
                                ...
                                <form action="<?= route('profil-desa.updateRawa', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PATCH')}}
                                    <div class="form-group row">
                                ...
                                <form action="<?= route('profil-desa.updateManfaatKondisiDanau', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PATCH')}}
                                    <div class="form-group row">
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('air-panas.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('air-panas.edit', $kud['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('air-panas.destroy', $kud['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <a href="<?= route('kualitas-udara.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('kualitas-udara.edit', $kud['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('kualitas-udara.destroy', $kud['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <a href="<?= route('kebisingan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('kebisingan.edit', $bsg['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('kebisingan.destroy', $bsg['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <a href="<?= route('ruang-publik.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('ruang-publik.edit', $rpt['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('ruang-publik.destroy', $rpt['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <a href="<?= route('potensi-wisata.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('potensi-wisata.edit', $ptws['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('potensi-wisata.destroy', $ptws['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <a href="<?= route('lembaga-kemasyarakatan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('lembaga-kemasyarakatan.edit', $lmsk['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('lembaga-kemasyarakatan.destroy', $lmsk['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <a href="<?= route('tingkat-partisipasi-politik.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('tingkat-partisipasi-politik.edit', $tpp['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('tingkat-partisipasi-politik.destroy', $tpp['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <a href="<?= route('lembaga-ekonomi.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('lembaga-ekonomi.edit', $lmbe['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('lembaga-ekonomi.destroy', $lmbe['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('jasa-lembaga-keuangan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('jasa-lembaga-keuangan.edit', $jlk['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('jasa-lembaga-keuangan.destroy', $jlk['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('industri-kecil.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('industri-kecil.edit', $indk['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('industri-kecil.destroy', $indk['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('usaha-jasa-pengangkutan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-pengangkutan.edit', $uspg1['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-pengangkutan.destroy', $uspg1['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-pengangkutan.edit', $uspg2['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-pengangkutan.destroy', $uspg2['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-pengangkutan.edit', $uspg3['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-pengangkutan.destroy', $uspg3['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-pengangkutan.edit', $uspg4['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-pengangkutan.destroy', $uspg4['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-pengangkutan.edit', $uspg5['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-pengangkutan.destroy', $uspg5['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('usaha-jasa-perdagangan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-perdagangan.edit', $ujp['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-perdagangan.destroy', $ujp['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('usaha-jasa-hiburan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-hiburan.edit', $ujh['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-hiburan.destroy', $ujh['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('usaha-jasa-gas.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-gas.edit', $ujg['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-gas.destroy', $ujg['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('usaha-jasa-keterampilan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-keterampilan.edit', $ujk['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-keterampilan.destroy', $ujk['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('usaha-jasa-hukum.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-hukum.edit', $ushk['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-hukum.destroy', $ushk['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('usaha-jasa-penginapan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('usaha-jasa-penginapan.edit', $uspn['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('usaha-jasa-penginapan.destroy', $uspn['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <a href="<?= route('pendidikan-formal.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('pendidikan-formal.edit', $pddf['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('pendidikan-formal.destroy', $pddf['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('pendidikan-keagamaan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('pendidikan-keagamaan.edit', $pdf1['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('pendidikan-keagamaan.destroy', $pdf1['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('pendidikan-keagamaan.edit', $pdf2['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('pendidikan-keagamaan.destroy', $pdf2['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('pendidikan-keagamaan.edit', $pdf3['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('pendidikan-keagamaan.destroy', $pdf3['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('pendidikan-keagamaan.edit', $pdf4['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('pendidikan-keagamaan.destroy', $pdf4['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('pendidikan-keagamaan.edit', $pdf5['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('pendidikan-keagamaan.destroy', $pdf5['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('pendidikan-keagamaan.edit', $pdf6['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('pendidikan-keagamaan.destroy', $pdf6['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('pendidikan-non-formal.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('pendidikan-non-formal.edit', $pdnf['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('pendidikan-non-formal.destroy', $pdnf['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                    ...
                    <div class="accordion-item">
                        <form action="<?= route('profil-desa.updateLembagaAdat', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH')}}
                    ...
                    <div class="accordion-item">
                        <form action="<?= route('profil-desa.updateLembagaKeamanan', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH')}}
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <a href="<?= route('prasarana-darat.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('prasarana-darat.edit', $psd['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('prasarana-darat.destroy', $psd['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('sarana-darat.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('sarana-darat.edit', $srnd['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('sarana-darat.destroy', $srnd['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('prasarana-laut.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('prasarana-laut.edit', $psrnl['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('prasarana-laut.destroy', $psrnl['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('sarana-laut.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('sarana-laut.edit', $srnl['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('sarana-laut.destroy', $srnl['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('prasarana-udara.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('prasarana-udara.edit', $psrnud['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('prasarana-udara.destroy', $psrnud['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFourteen" class="accordion-collapse collapse" aria-labelledby="headingFourteen" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <a href="<?= route('telepon.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('telepon.edit', $tlp['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('telepon.destroy', $tlp['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('kantorpos.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('kantorpos.edit', $ktp['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('kantorpos.destroy', $ktp['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('radiotv.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('radiotv.edit', $rtv['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('radiotv.destroy', $rtv['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('koran.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('koran.edit', $krn['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('koran.destroy', $krn['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                    ...
                    <div class="accordion-item">
                        <form action="<?= route('profil-desa.updatePrasaranaAirBersih', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH')}}
                    ...
                    <div class="accordion-item">
                        <form action="<?= route('profil-desa.updatePrasaranaIrigasi', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH')}}
                    ...
                    <div class="accordion-item">
                        <form action="<?= route('profil-desa.updatePrasaranaPemerintahan', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH')}}
                    ...
                    <div class="accordion-item">
                        <form action="<?= route('profil-desa.updatePrasaranaBPDDusun', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH')}}
                    ...
                    <div class="accordion-item">
                        <form action="<?= route('profil-desa.updatePrasaranaLKDK', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH')}}
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwenty" class="accordion-collapse collapse" aria-labelledby="headingTwenty" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <a href="<?= route('prasarana-peribadatan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('prasarana-peribadatan.edit', $ppd['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('prasarana-peribadatan.destroy', $ppd['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('prasarana-olahraga.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('prasarana-olahraga.edit', $por['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('prasarana-olahraga.destroy', $por['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwentyOne" class="accordion-collapse collapse" aria-labelledby="headingTwentyOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <a href="<?= route('prasarana-kesehatan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('prasarana-kesehatan.edit', $psksh['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('prasarana-kesehatan.destroy', $psksh['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('sarana-kesehatan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('sarana-kesehatan.edit', $sksht['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('sarana-kesehatan.destroy', $sksht['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('prasarana-sarana-pendidikan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('prasarana-sarana-pendidikan.edit', $psp['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('prasarana-sarana-pendidikan.destroy', $psp['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwentyTwo" class="accordion-collapse collapse" aria-labelledby="headingTwentyTwo" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <a href="<?= route('prasarana-energi-penerangan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('prasarana-energi-penerangan.edit', $pep['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('prasarana-energi-penerangan.destroy', $pep['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('prasarana-hiburan-wisata.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('prasarana-hiburan-wisata.edit', $phw['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('prasarana-hiburan-wisata.destroy', $phw['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                                ...
                                <div class="border-top">
                                    ...
                                    <a href="<?= route('prasarana-sarana-kebersihan.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-2">
                                                            <a href="<?= route('prasarana-sarana-kebersihan.edit', $psb['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <form action="<?= route('prasarana-sarana-kebersihan.destroy', $psb['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
