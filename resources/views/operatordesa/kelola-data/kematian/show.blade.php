    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">LIHAT DATA KEMATIAN</h4>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="tanggal_meninggal" value="<?= date("m/d/Y", $time = strtotime($datakematian->tanggal_meninggal)); ?>" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text h-100"><i class="fa fa-calendar"></i></span>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="tempat_meninggal" name="tempat_meninggal" value="<?= $datakematian->tempat_meninggal ?>" readonly>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="sebab_meninggal" name="sebab_meninggal" value="<?= $datakematian->sebab_meninggal ?>" readonly>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="rt" name="rt" value="<?= $datakematian->datapenduduk->desa->name ?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
