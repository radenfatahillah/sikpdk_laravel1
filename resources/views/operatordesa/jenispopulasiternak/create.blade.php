    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">TAMBAH DATA JENIS POPULASI TERNAK</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('jenis-populasi-ternak.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kgjenispopulasiternak_id" class="form-control">
                                        <?php foreach ($kgjenispopulasiternak as $kgt) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="jumlahpemilik" name="jumlahpemilik" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="perkiraanjumlah" class="col-sm-3 text-end control-label col-form-label">Perkiraan Jumlah Populasi (Ekor)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="perkiraanjumlah" name="perkiraanjumlah" placeholder="Contoh : 1" required>
                                </div>
                            </div>
                        </div>
