    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">TAMBAH DATA KUALITAS UDARA</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" action="<?= route('kualitas-udara.store') ?>" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kgkualitasudara_id" class="form-control">
                                        <?php foreach ($kgkualitasudara as $kgt) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="polutan" name="polutan" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="efek">
                                        <option value="Gangguan Penglihatan/Kabut"> Gangguan Penglihatan/Kabut </option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pemerintah" name="pemerintah" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="swasta" class="col-sm-3 text-end control-label col-form-label">Kepemilikan (Swasta)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="swasta" name="swasta" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="perorangan" class="col-sm-3 text-end control-label col-form-label">Kepemilikan (Perorangan)</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="perorangan" name="perorangan" required>
                                </div>
                            </div>
                        </div>
