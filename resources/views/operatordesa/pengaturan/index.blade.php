    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">LIHAT DATA APARATUR DESA</h4>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <a href="<?= route('perangkat-desa.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $prd['status'] }}</td>
                                                        <td>
                                                            <a href="<?= route('perangkat-desa.edit', $prd['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('perangkat-desa.destroy', $prd['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <a href="<?= route('bpd-desa.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= route('bpd-desa.edit', $bpd['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('bpd-desa.destroy', $bpd['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <a href="<?= route('pengaturan-desa.create') ?>" type="button" class="btn btn-primary btn-sm mb-2">Tambah Data</a>
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $almt['status'] }}</td>
                                                        <td>
                                                            <a href="<?= route('pengaturan-desa.edit', $almt['id']) ?>" type="button" class="btn btn-sm btn-success">Edit</a>
                                                            <form action="<?= route('pengaturan-desa.destroy', $almt['id']) ?>" method="POST" onclick="return confirm('Confirm delete?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <input type="submit" class="btn btn-sm btn-danger" value="Delete">
                                                            </form>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        @endforeach
                                        <form action="<?= route('pengaturan-desa.updateAparaturDesa', ['id' => Auth::user()->desa_id]) ?>" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            {{ method_field('PATCH')}}
